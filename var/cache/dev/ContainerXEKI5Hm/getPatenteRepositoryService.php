 ...
 */
class getPatenteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PatenteRepository' shared autowired service.
     *
     * @return \App\Repository\PatenteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PatenteRepository.php';

        return $container->privates['App\\Repository\\PatenteRepository'] = new \App\Repository\PatenteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
