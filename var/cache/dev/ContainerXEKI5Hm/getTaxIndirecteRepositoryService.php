 ...
 */
class getTaxIndirecteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxIndirecteRepository' shared autowired service.
     *
     * @return \App\Repository\TaxIndirecteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxIndirecteRepository.php';

        return $container->privates['App\\Repository\\TaxIndirecteRepository'] = new \App\Repository\TaxIndirecteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
