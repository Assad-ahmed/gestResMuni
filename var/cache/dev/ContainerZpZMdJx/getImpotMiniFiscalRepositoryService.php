 ...
 */
class getImpotMiniFiscalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ImpotMiniFiscalRepository' shared autowired service.
     *
     * @return \App\Repository\ImpotMiniFiscalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ImpotMiniFiscalRepository.php';

        return $container->privates['App\\Repository\\ImpotMiniFiscalRepository'] = new \App\Repository\ImpotMiniFiscalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
