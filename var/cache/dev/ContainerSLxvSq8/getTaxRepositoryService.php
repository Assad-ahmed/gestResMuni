 ...
 */
class getTaxRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxRepository' shared autowired service.
     *
     * @return \App\Repository\TaxRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxRepository.php';

        return $container->privates['App\\Repository\\TaxRepository'] = new \App\Repository\TaxRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
