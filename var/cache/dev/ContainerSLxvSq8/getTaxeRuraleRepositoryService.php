 ...
 */
class getTaxeRuraleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxeRuraleRepository' shared autowired service.
     *
     * @return \App\Repository\TaxeRuraleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxeRuraleRepository.php';

        return $container->privates['App\\Repository\\TaxeRuraleRepository'] = new \App\Repository\TaxeRuraleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
