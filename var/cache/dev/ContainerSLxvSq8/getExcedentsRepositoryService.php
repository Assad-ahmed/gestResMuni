 ...
 */
class getExcedentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExcedentsRepository' shared autowired service.
     *
     * @return \App\Repository\ExcedentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExcedentsRepository.php';

        return $container->privates['App\\Repository\\ExcedentsRepository'] = new \App\Repository\ExcedentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
