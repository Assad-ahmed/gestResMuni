 ...
 */
class getRistournesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RistournesRepository' shared autowired service.
     *
     * @return \App\Repository\RistournesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RistournesRepository.php';

        return $container->privates['App\\Repository\\RistournesRepository'] = new \App\Repository\RistournesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
