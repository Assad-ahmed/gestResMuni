 ...
 */
class ImpotTOM extends \App\Entity\ImpotTOM implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'valeurLocative', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'region', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'montant', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'taux', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'date', '' . "\0" . 'App\\Entity\\ImpotTOM' . "\0" . 'propriete'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImpotTOM $proxy) {
     ...
     * {@inheritDoc}
     */
    public function calculerImpotTOM(): \App\Entity\ImpotTOM
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'calculerImpotTOM', []);

        return parent::calculerImpotTOM();
    }
     ...
     * {@inheritDoc}
     */
    public function getPropriete(): ?\App\Entity\Propriete
    {
     ...
     * {@inheritDoc}
     */
    public function setPropriete(?\App\Entity\Propriete $propriete): static
    {
