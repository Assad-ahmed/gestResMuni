 ...
 */
class ImpotCFPB extends \App\Entity\ImpotCFPB implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'typeBatiment', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'valeurLocative', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'revenuNet', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'date', '' . "\0" . 'App\\Entity\\ImpotCFPB' . "\0" . 'montant'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImpotCFPB $proxy) {
