...
class Propriete extends \App\Entity\Propriete implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'telephone', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'adresse', '' . "\0" . 'App\\Entity\\Propriete' . "\0" . 'impotTOMs'];
        }
