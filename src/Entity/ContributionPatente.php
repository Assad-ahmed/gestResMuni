...
use App\Repository\ContributionPatenteRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContributionPatenteRepository::class)]
class ContributionPatente
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToMany(targetEntity: SiteCollecte::class, inversedBy: 'contributionPatentes')]
